...
import heapq   # modul bawaan Python untuk struktur data priority queue (heap), digunakan agar kita bisa selalu mengambil node dengan nilai f terkecil dengan efisien
